...
function Yo(){
  let num1 = parseInt(document.getElementById("input_quizzes1").value);
  let num2 = parseInt(document.getElementById("input_quizzes2").value);
  let num3 = parseInt(document.getElementById("input_quizzes3").value);
  document.getElementById("sampled_quizzes").innerHTML = num1 * 275 + num2 * 236 + num3 * 315;
}
function Yoo(){  
  let num1 = parseInt(document.getElementById("input_quizzes1").value);
  let num2 = parseInt(document.getElementById("input_quizzes2").value);
  let num3 = parseInt(document.getElementById("input_quizzes3").value);
  let num4 = parseInt(document.getElementById("input_quizzes4").value);
  let cost = num1 * 275 + num2 * 236 + num3 * 315;
  let refund = num4 - cost;
  document.getElementById("sampled_quizzes").innerHTML = num4 + " - " + cost + " = " + refund;
}
function Clean(){
  document.getElementById("input_quizzes1").value = 0;
  document.getElementById("input_quizzes2").value = 0;
  document.getElementById("input_quizzes3").value = 0;
  document.getElementById("input_quizzes4").value = 0;
  document.getElementById("sampled_quizzes").innerHTML = "";
}
function add(eleId){
